...
@section('style')
    <link rel="stylesheet" href="{{ asset('css/customizeTower.css') }}">
@endsection
            ...
            <div class="col-lg-6 col-12">
                ...
                <div class="w-100 overflow-hidden">
                    <div class="d-flex wrapper-customize-menu" id="customize-menu">
                                ...
                                <div class="col-4 p-2">
                                    <div class="card w-100 ratio ratio-1x1 text-center" onclick="previewLayer(2)">
                                        <img class="object-fit-scale w-75 h-75 m-3"
                                            src="{{ asset('assets/images/Pilihan Tower/preview-tower-layer-2.png') }}"
                                            alt="">
                                    </div>
                                </div>
                                <div class="col-4 p-2">
                                    <div class="card w-100 ratio ratio-1x1 text-center" onclick="previewLayer(3)">
                                        <img class="object-fit-scale w-75 h-75 m-3"
                                            src="{{ asset('assets/images/Pilihan Tower/preview-tower-layer-3.png') }}"
                                            alt="">
                                    </div>
                                </div>
                                <div class="col-4 p-2">
                                    <div class="card w-100 ratio ratio-1x1 text-center" onclick="previewLayer(4)">
                                        <img class="object-fit-scale w-75 h-75 m-3"
                                            src="{{ asset('assets/images/Pilihan Tower/preview-tower-layer-4.png') }}"
                                            alt="">
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-img-top ratio ratio-1x1">
                                                        <img class="object-fit-scale"
                                                            src="{{ asset('assets/images/Snack Satuan/' . $s->snack->image) }}"
                                ...
                                <div class="row d-flex p-3">
                                    <div class="col-4 p-2">
                                        <div class="card ">
                                            <div class="card-img-top ratio ratio-1x1">
                                                <img class="object-fit-scale"
                                                    src="{{ asset('assets/images/Dekorasi/not-use.png') }}"
                                                    alt="Title" id="list-snack" />
                                            </div>
                                            <div class="card-body">
                                    ...
                                    @forelse ($decoration as $d)
                                        <div class="col-4 p-2">
                                            <div class="card ">
                                                <div class="card-img-top ratio ratio-1x1">
                                                    <img class="object-fit-scale"
                                                        src="{{ asset('assets/images/Dekorasi/' . $d->image) }}"
                                                        alt="Title" id="list-snack" />
                                                </div>
                                                <div class="card-body">
                        ...
                        <form action="{{ route('customizeUser.store') }}" method="POST" class="position-relative py-3"
                            ...
                            <div class="list-snack overflow-scroll overflow-x-hidden mt-3">
                                ...
                                <input type="hidden" name="type" value="tower">
